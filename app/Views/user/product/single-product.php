...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('public/css/ion.rangeSlider.css') ?>" />
    <link rel="stylesheet" href="<?= base_url('public/css/ion.rangeSlider.skinFlat.css') ?>" />
            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        ...
                        <!-- <a hrefFit Health<span class="lnr lnr-arrow-right"></span></a> -->
            ...
            <div class="row s_product_inner">
                <div class="col-lg-6">
                    <div class="s_Product_carousel">
                        <div class="single-prd-item">
                            <img class="img-fluid" src="<?= base_url('public/uploads/' . $items['image']) ?>" alt="">
                        </div>
                        <div class="single-prd-item">
                            <img class="img-fluid" src="<?= base_url('public/uploads/' . $items['image']) ?>" alt="">
                        </div>
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        <h2>$<?= ($items['price']) ?></h2>
                        <ul class="list">
                            <li><a class="active" href="#"><span>Category</span> : <?= ($items['category']) ?></a></li>
                            <li>
                                <a>
                                    <span>Availibility</span> : <?php if ($items['status'] == 0) { ?>
                                        Out of Stock
                                    <?php } else { ?>
                                        In stock
                                    <?php } ?>
                        ...
                        <div class="card_area d-flex align-items-center">
                            ...
                            <?php } else { ?>
                                <a class="primary-btn" href="<?php echo base_url('buy/' . $items['id']); ?>">Add to Cart</a>
                            <?php } ?>
                            <!-- <a class="social-info" href="#"><span class="ti-bag"></span></a> -->
